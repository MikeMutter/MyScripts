...
${reset}                                     "
    ...
    cat $url/recon/httprobe/final.txt | sort -u | httprobe -s -p https:80 | sed 's/http\?:\/\///' | tr -d ':80' | tee -a $url/recon/httprobe/a1.txt
    sort -u $url/recon/httprobe/a.txt > $url/recon/httprobe/alive.txt
    sort -u $url/recon/httprobe/a1.txt >> $url/recon/httprobe/alive.txt
    rm $url/recon/httprobe/a.txt
    rm $url/recon/httprobe/a1.txt
